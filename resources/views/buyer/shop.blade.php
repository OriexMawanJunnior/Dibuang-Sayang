<x-buyer-layout>
    <div class="Banner flex justify-center">
        <div class="Banner w-full h-[350px] bg-[#DFAEA1] flex flex-col justify-center items-start px-16">
            <div class="text-indigo-900 text-4xl font-bold">Kategori</div>
            <div class="text-indigo-900 text-2xl font-normal mt-4">Makanan Berat</div>
            <div class="w-full h-24 bg-white rounded-lg shadow mt-6 flex items-center px-8">
                ...
                <div class="text-black text-xl font-normal mx-2">></div>
                <div class="text-black text-xl font-medium">Kategori</div>
                <div class="text-black text-xl font-normal mx-2">></div>
                <div class="text-black text-xl font-medium">Makanan Berat</div>
            </div>
        </div>
    </div>
    ...
    <div class="Group3 flex justify-center mt-8">
        <div class="w-full max-w-screen-lg flex flex-col">
            <div class="flex items-center justify-between border-b border-indigo-900/80 pb-2">
                <div class="text-black text-2xl font-semibold">Filters</div>
                <div class="flex items-center">
                    <div class="text-black text-2xl font-semibold">Diurutkan dari</div>
                    <div class="text-black text-2xl font-medium mx-2">Terpopuler</div>
                    <!-- Icon ArrowDown -->
                </div>
                <div class="text-right text-black text-2xl font-medium">
