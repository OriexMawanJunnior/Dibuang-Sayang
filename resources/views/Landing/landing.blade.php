...
<head>
 ...
 <body class="font-['Quicksand'] bg-[#FFFCF5] overflow-x-hidden" style="zoom: 100%" >
...
<div class="Frame46 w-[370px] h-[375px] flex-col justify-center items-center inline-flex ">
    <div class="Group17 w-[370px] h-[375px] relative">
      <div class="PrimaryButton w-[140px] h-[42px] px-3 left-[115px] top-[333px] absolute bg-indigo-900 rounded-lg flex-col justify-center items-center gap-[5px] inline-flex">
        <div class="SeeMore text-center text-slate-300 text-xs font-semibold font-['Quicksand'] leading-[14px]">Mulai Berbelanja</div>
      </div>
      <div class="Frame43 w-[370px] h-[249.68px] left-0 top-[53px] absolute justify-start items-start gap-2.5 inline-flex">
        <div class="Group8 w-[180px] h-[249.68px] relative">
          <div class="Rectangle42 w-[180px] h-[249.68px] left-0 top-0 absolute bg-white rounded-[10px] shadow border-2"></div>
          <div class="010Penilaian left-[46px] top-[217px] absolute text-black text-xs font-normal font-['Quicksand']">5.0 • 10 penilaian</div>
          <div class="IconEmojioneStar w-[25px] h-[25px] px-[0.78px] py-[1.17px] left-[16px] top-[212px] absolute justify-center items-center inline-flex"></div>
          <div class="Rectangle40 w-[30px] h-5 left-[16px] top-[186px] absolute bg-red-300 rounded-sm"></div>
          <div class=" left-[20px] top-[188px] absolute text-black text-xs font-normal font-['Quicksand']">50%</div>
          <div class="000 left-[55px] top-[188px] absolute text-black/opacity-50 text-xs font-normal font-['Quicksand'] line-through">12.000</div>
          <div class="000 left-[99px] top-[188px] absolute text-black text-xs font-semibold font-['Quicksand']">6.000</div>
          <div class="JCo left-[16px] top-[165px] absolute text-black text-xs font-normal font-['Quicksand']">J.CO</div>
          <div class="Donut left-[16px] top-[136px] absolute text-black text-lg font-semibold font-['Quicksand']">Donut</div>
          <div class="05Km left-[16px] top-[115px] absolute text-black text-xs font-normal font-['Quicksand']">1.05 km</div>
          <img class="Rectangle41 w-[127.78px] h-[95px] left-[26px] top-[15px] absolute rounded-[10px] border" src="https://via.placeholder.com/128x95" />
          <div class="Frame2 w-[33px] h-[33px] left-[16px] top-[15px] absolute">
            <div class="Ellipse10 w-[33px] h-[33px] left-0 top-0 absolute bg-white rounded-full border border-black"></div>
            <div class="Frame2 w-[33px] h-[33px] pl-[6.60px] pr-[7.15px] pt-[6.60px] pb-[7.15px] left-0 top-0 absolute justify-center items-center inline-flex">
              <div class="Heart w-[19.25px] h-[19.25px] relative">
              </div>
            </div>
          </div>
        </div>
        <div class="Group9 w-[180px] h-[249.68px] relative">
          <div class="Rectangle42 w-[180px] h-[249.68px] left-0 top-0 absolute bg-white rounded-[10px] shadow border-2"></div>
          <div class="010Penilaian left-[46px] top-[217px] absolute text-black text-xs font-normal font-['Quicksand']">5.0 • 10 penilaian</div>
          <div class="IconEmojioneStar w-[25px] h-[25px] px-[0.78px] py-[1.17px] left-[16px] top-[212px] absolute justify-center items-center inline-flex"></div>
          <div class="Rectangle40 w-[30px] h-5 left-[16px] top-[186px] absolute bg-red-300 rounded-sm"></div>
      ...
      <div class="DiSekitarmu left-[1px] top-0 absolute text-indigo-900 text-xl font-bold font-['Quicksand']">Di Sekitarmu</div>
      <div class="LihatSekitarAdaMakananYangBisaKitaSelamatkan left-[1px] top-[24px] absolute text-indigo-900 text-xs font-normal font-['Quicksand']">Lihat sekitar, ada makanan yang bisa kita selamatkan!</div>
    </div>
  </div>
</div>
